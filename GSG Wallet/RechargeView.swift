...
struct RechargeView: View {
    // 使用 @State 来存储当前选择的地址
    @State private var selectedAddress: String = "0x4ECF108a8cF5A981D6B20BA619b6C75a46DA1c4D"
    ...
    var body: some View {
        VStack(spacing: 20) {
            ...
            HStack {
                Button(action: {
                    // 切换到 ETH/ERC20 网络
                    selectedAddress = "0x4ECF108a8cF5A981D6B20BA619b6C75a46DA1c4D"
                }) {
                    Text("ETH/ERC20")
                        .padding()
                ...
                Button(action: {
                    // 切换到 Tron/TRC20 网络
                    selectedAddress = "TT8i1yRfNqGL7uudFNgruUFJpqchJjXYZF"
                }) {
                    Text("Tron/TRC20")
                        .padding()
                        .background(Color.gray.opacity(0.2))
